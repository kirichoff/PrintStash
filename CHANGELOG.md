...
### Added
- **Drag file(s) or folder directly** in the new port (or over a specific folder) to open a prefilled upload wizard (@JrVolt)
...
### Changed
- **Drag is now available in every tab** o the upload wizard (@JrVolt)
